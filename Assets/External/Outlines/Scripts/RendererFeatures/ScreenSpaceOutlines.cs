...
public class ScreenSpaceOutlines : ScriptableRendererFeature {
    ...
    private class ScreenSpaceOutlinePass : ScriptableRenderPass {
        ...
        public ScreenSpaceOutlinePass(RenderPassEvent renderPassEvent, ScreenSpaceOutlineSettings settings) {
            ...
            Color transparentCol = settings.outlineColor;
            transparentCol.a = 0;
            Color finalCol = Color.Lerp(transparentCol, col, settings.fadeSpeed);
            screenSpaceOutlineMaterial.SetColor("_OutlineColor", finalCol);
    ...
    [SerializeField] public ScreenSpaceOutlineSettings outlineSettings = new ScreenSpaceOutlineSettings();
